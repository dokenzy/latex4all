...
이것이 가능하려면 프리앰블에서 다음 명령을 선언해야한다.
\begin{pyglist}
\defaultfontfeatures{Ligatures=TeX}|
\end{pyglist}
이 명령은 fontspec이 제공한다.\footnote{자세한 내용은 KTUG QnA 게시판에 두텁님이 쓰신 \href{http://www.ktug.org/xe/index.php?mid=KTUG_QnA_board&page=2&document_srl=176043}{답글}을 읽어보자.}
